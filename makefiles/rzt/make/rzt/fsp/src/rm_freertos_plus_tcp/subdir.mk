...
C_SRCS += \
../rzt/fsp/src/rm_freertos_plus_tcp/NetworkInterface.c 

LST += \
NetworkInterface.lst 

C_DEPS += \
./rzt/fsp/src/rm_freertos_plus_tcp/NetworkInterface.d 

OBJS += \
./rzt/fsp/src/rm_freertos_plus_tcp/NetworkInterface.o 
...
rzt/fsp/src/rm_freertos_plus_tcp/%.o: ../rzt/fsp/src/rm_freertos_plus_tcp/%.c
	@echo 'Building file: $<'
