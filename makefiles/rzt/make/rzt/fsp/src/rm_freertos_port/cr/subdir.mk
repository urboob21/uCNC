...
C_SRCS += \
../rzt/fsp/src/rm_freertos_port/cr/port.c 

LST += \
port.lst 

C_DEPS += \
./rzt/fsp/src/rm_freertos_port/cr/port.d 

OBJS += \
./rzt/fsp/src/rm_freertos_port/cr/port.o 
...
rzt/fsp/src/rm_freertos_port/cr/%.o: ../rzt/fsp/src/rm_freertos_port/cr/%.c
	@echo 'Building file: $<'
